...
public class Example15 {
    ...
    /**
     * Exemplo para adicionar lista na tabela do PDF
     * @param args
    ...
    public static void main(String[] args) throws IOException {
        ...
        PdfWriter pdfWriter = new PdfWriter(projectPath + "/" + Example15.class.getName() + "-pdf");
        ...
        List list = new List();
        list.add("Apple").add("Banana").add("Orande");
